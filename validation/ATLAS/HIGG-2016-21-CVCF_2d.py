...
data2 = np.genfromtxt("validation/ATLAS/HIGG-2016-21-CVCF_2d_rounded.out")
...
plt.text(0.58, 1.42, r'Data from ATLAS-HIGG-2016-21', fontsize=13)
#plt.text(0.58, 1.32, r'Fig. 12 + Fig. 40a', fontsize=13)
...
fig.savefig("validation/ATLAS/HIGG-2016-21-CVCF.pdf")
