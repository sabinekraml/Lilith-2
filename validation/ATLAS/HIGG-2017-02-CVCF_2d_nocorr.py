...
plt.text(0.15, 1.8, r'Combination of ATLAS ttH data', fontsize=13)
plt.text(0.15, 1.7, r'(without correlations)', fontsize=11)
...
fig.savefig("validation/ATLAS/HIGG-2017-02-CVCF-nocorr.pdf")
