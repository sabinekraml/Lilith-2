...
f = open('HIGG-2016-07_Llh-2d-Grid95.txt', 'r')
...
print("\n Parameters:")
print("sig1p, sig1m =", ff[0], ff[1])
print("sig2p, sig2m =", ff[2], ff[3])
print("corr =", ff[4])

#sys.exit("end here")

# Open the 2D grid files
f = open('HIGG-2016-07_Llh-2d-GridFull.txt', 'r')
...
plt.xlim(0,2)
plt.ylim(-0.5,2)
plt.xlabel(r'$\mu({\rm ggH},WW)$',fontsize=25)
plt.ylabel(r'$\mu({\rm VBF},WW)$',fontsize=25)
plt.text(0.11, 1.75, 'Data from ATLAS-HIGG-2016-07:', fontsize=13)
plt.text(0.11, 1.62, 'Var. Gaussian fitted to ATLAS 95% CL contour', fontsize=13)

fig.set_tight_layout(True)

# Saving figure (.pdf)
fig.savefig("HIGG-2016-07-mu-2d.pdf")
