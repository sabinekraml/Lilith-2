...
expCont = np.genfromtxt('validation/ATLAS/HIGG-2017-02-CVCF-2d-Grid.txt', dtype=dt)
plt.plot(expCont['cx'],expCont['cy'], '.', c='b', label='ATLAS-HIGG-2017-02')
...
plt.text(0.13, 1.82, r'Combination of ATLAS ttH data:', fontsize=13)
#plt.text(0.13, 1.7, r'best fits & uncertainies as given in HIGG-2017-02,', fontsize=11)
plt.text(0.13, 1.7, r'best fits & uncertainies from individual analyses,', fontsize=11)
plt.text(0.13, 1.62, r'correlations fitted from HIGG-2017-02 Figs. 17a,b ', fontsize=11)
# fitted from HIGG-2017-02 Figs. 17a,b
...
fig.savefig("validation/ATLAS/HIGG-2017-02-CVCF-off-corr-v2.pdf")
