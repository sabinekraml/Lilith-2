...
expCont = np.genfromtxt('validation/CMS/HIG-17-031-Type_II_2HDM-Grid.txt', dtype=dt)
...
plt.text(0.19, 0.27, r'2HDM Type-II', fontsize=15)
plt.text(0.19, 0.2, r'Data from CMS-HIG-17-031', fontsize=15)
...
fig.savefig("validation/CMS/HIG-17-031-2HDM-Type2.pdf")
