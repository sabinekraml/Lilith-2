...
# Output file
output = "validation/CMS/CVCF_2d.out"
# Output plot
outputplot = "validation/CMS/CVCF_2d.pdf"
...
expCont = np.genfromtxt('validation/CMS/HIG-17-031_CVCF-combined-2d-Grid.txt', dtype=dt)
plt.plot(expCont['cx'],expCont['cy'], '.', c='b', label='CMS official')

#expCont2 = np.genfromtxt('validation/CMS/HIG-17-031_CVCF-gaga-2d-Grid.txt', dtype=dt)
#plt.plot(expCont2['cx'],expCont2['cy'], '.', c='k', label='CMS gamgam')
...
plt.text(0.85, 1.37, r'Data from CMS-HIG-17-031', fontsize=13)
#plt.text(0.85, 1.32, r'(using ordinary Gaussian)', fontsize=13)
#plt.text(0.8, 1.22, r'(testing)', fontsize=13)
...
fig.savefig("validation/CMS/HIG-17-031-CVCF-v2.pdf")
