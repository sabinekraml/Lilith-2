...
# Output file
if type == 1:
  output = "validation/CMS/cba_tb_I_h_2d.out"
  outputplot = "validation/CMS/cba_tb_I_h_2d.pdf"

if type == 2:
  output = "validation/CMS/cba_tb_II_h_2d.out"
  outputplot = "validation/CMS/cba_tb_II_h_2d.pdf"
...
expCont = np.genfromtxt('validation/CMS/HIG-17-031-Type_I_2HDM-Grid.txt', dtype=dt)
plt.plot(expCont['cx'],expCont['cy'], '.', c='b', label='CMS official 95% CL')
plt.legend(loc='lower right', fontsize=12)

# Title, labels, color bar etc.
plt.title("          Lilith-"+str(lilith.__version__)+", DB "+str(lilithcalc.dbversion), fontsize=15, ha="left")
plt.text(0.15, 0.3, r'2HDM Type-I', fontsize=15)
plt.text(0.15, 0.22, r'Data from ', fontsize=15)
plt.text(0.15, 0.17, r'CMS-HIG-17-031', fontsize=15)
...
fig.savefig("validation/CMS/HIG-17-031-2HDM-Type1.pdf")
