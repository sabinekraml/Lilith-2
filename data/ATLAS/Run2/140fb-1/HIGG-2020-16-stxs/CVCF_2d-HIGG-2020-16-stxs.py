...
exp_input = "validations/ATLAS/HIGG-2020-16-stxs/stxs.list"
...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "validations/ATLAS/HIGG-2020-16-stxs/results/CVCF_2d.out"
outputplot = "validations/ATLAS/HIGG-2020-16-stxs/results/CVCF_2d_STXS.pdf"
...
dataload = open('validations/ATLAS/HIGG-2020-16-stxs/officialData/CVCF-HIGG-2020-16.csv','r')
dorix = []
doriy = []
