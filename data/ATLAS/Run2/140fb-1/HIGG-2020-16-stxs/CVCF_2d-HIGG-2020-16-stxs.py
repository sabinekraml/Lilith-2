...
exp_input = "data/ATLAS/Run2/140fb-1/HIGG-2020-16-stxs/stxs.list"
...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "data/ATLAS/Run2/140fb-1/HIGG-2020-16-stxs/results/CVCF_2d.out"
outputplot = "data/ATLAS/Run2/140fb-1/HIGG-2020-16-stxs/results/CVCF_2d_stxs-vh.pdf"
...
plt.minorticks_on()
plt.tick_params(labelsize=10, length=10, width=2)
plt.tick_params(which='minor', length=5, width=1.2)
...
#plt.plot([1.0350194552529182], [0.9533596837944663], '*', c='b', ms=10, label="Official best fit")

# Import Official data from file 
dataload = open('data/ATLAS/Run2/140fb-1/HIGG-2020-16-stxs/officialData/CVCF-HIGG-2020-16.csv','r')
dorix = []
doriy = []
...
#plt.plot(dorix, doriy, '.', markersize=4, color='blue', label="ATLAS official")
...
plt.text(0.86, 1.6, r'ggF 2017 correlation', fontsize=10)
...
print("results are stored in", lilith_dir + "/validations/ATLAS/HIGG-2020-16-stxs/results")
print("***** done *****")
