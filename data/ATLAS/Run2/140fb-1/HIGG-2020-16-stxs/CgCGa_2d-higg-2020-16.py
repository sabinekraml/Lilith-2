...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "validations/ATLAS/HIGG-2020-16/CgCGa-HIGG-2020-16-cor.out"
outputplot = "validations/ATLAS/HIGG-2020-16/CgCGa-HIGG-2020-16-cor.pdf"
...
dataload = open('validations/ATLAS/HIGG-2020-16/CgCGa-HIGG-2020-16.csv','r')
dorix = []
doriy = []
