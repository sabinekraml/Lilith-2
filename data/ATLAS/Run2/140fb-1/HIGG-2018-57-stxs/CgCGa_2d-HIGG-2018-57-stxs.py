...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "validations/ATLAS/HIGG-2018-57-stxs/results/CgCGa-HIGG-2018-57-stxs.out"
outputplot = "validations/ATLAS/HIGG-2018-57-stxs/results/CgCGa-HIGG-2018-57-stxs.pdf"
...
dataload = open('validations/ATLAS/HIGG-2018-57-stxs/officialData/HIGG-2018-57-CgCga-Official.csv','r')
dorix = []
doriy = []
