...
# data type, 1 for SS, 2 for STXS
data_type = 1

if data_type == 1:
    exp_input = "validations/ATLAS/HIGG-2018-57-2HDM/latestRun2-2HDM-ss.list"
    smpred_input = "validations/ATLAS/HIGG-2018-57-2HDM/SM-prediction-SS.txt"
    smbin_corr_input = "validations/ATLAS/HIGG-2018-57-2HDM/SM-corr.txt"
    output_type = "ss" 
if data_type == 2:
    exp_input = "validations/ATLAS/HIGG-2018-57-2HDM/latestRun2-2HDM-stxs.list"
    smpred_input = "validations/ATLAS/HIGG-2018-57-2HDM/SMPrediction-dim19.txt"
    smbin_corr_input = "validations/ATLAS/HIGG-2018-57-2HDM/SMbin-corrJVE.txt"
    output_type = "stxs"  
...
if type == 1:
  output = "validations/ATLAS/HIGG-2018-57-2HDM/output/"+output_type+"_cba_tb_I_h_2d.out"
  outputplot = "validations/ATLAS/HIGG-2018-57-2HDM/results/"+output_type+"_cba_tb_I_h_2d.pdf"

if type == 2:
  output = "validations/ATLAS/HIGG-2018-57-2HDM/output/"+output_type+"_cba_tb_II_h_2d.out"
  outputplot = "validations/ATLAS/HIGG-2018-57-2HDM/results/"+output_type+"_cba_tb_II_h_2d.pdf"
...
if data_type == 1:
    plt.title("Lilith-2.2, SS data from ATLAS HIGG-2018-57" , fontsize=15, ha="center")
else:
    plt.title("Lilith-2.2, STXS data from ATLAS HIGG-2018-57", fontsize=15, ha="center")
...
#  plt.text(0.08, 0.16, r'(ATLAS-HIGG-2018-57)', fontsize=12)
if type == 2:
  plt.xlim([-0.151,0.601])
  plt.text(0.4, 0.15, r'2HDM Type-II', fontsize=15)
#  plt.text(0.3, 0.16, r'(ATLAS-HIGG-2018-57)', fontsize=12)

fig.set_tight_layout(True)

# read data for official 68% and 95% CL contours & plot (added by TQL)
if type == 1:
    dataload = open('validations/ATLAS/HIGG-2018-57-2HDM/official-data/95CL-type1.csv','r')
if type == 2:
    dataload = open('validations/ATLAS/HIGG-2018-57-2HDM/official-data/95CL-type2.csv','r')    
dorix = []
doriy = []
...
print("results are stored in", lilith_dir + "/validations/ATLAS/HIGG-2018-57-2HDM/results")
print("***** done *****")
