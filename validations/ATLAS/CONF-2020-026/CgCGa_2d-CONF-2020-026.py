...
outputplot = "validations/ATLAS/CONF-2020-026/CgluCgam_2d.pdf"
...
# expdata = np.genfromtxt('validations/ATLAS/CONF-2020-027/ATLAS-CONF-2020-027-fig_12.txt')
# xExp = expdata[:,0]
# yExp = expdata[:,1]
...
plt.text(0.83, 1.3, r'Exp. input: ATLAS-CONF-2020-026.xml', fontsize=13)
...
print("results are stored in", lilith_dir + "/validations/ATLAS/CONF-2020-026/")
print("***** done *****")
