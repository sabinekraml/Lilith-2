...
# Sm predictions     
smpred_input = "validations/ATLAS/HIGG-2018-28-SMEFT/SMbin-prediction-x.txt"
...
outputplot = "validations/ATLAS/HIGG-2018-28-SMEFT/SMEFT-1d-cuH.pdf"
...
dataload = open('validations/ATLAS/HIGG-2018-28-SMEFT/cUH-obs.csv','r')
dorix = []
doriy = []
...
plt.text(5, 10, r'Data from ATLAS HIGG-2018-28', fontsize=10)
plt.text(5, 9, r'$H\to ZZ^*\to 4\ell$', fontsize=10)
