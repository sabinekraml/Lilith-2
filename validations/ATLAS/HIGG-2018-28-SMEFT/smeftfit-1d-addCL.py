...
smeft_input = "validations/ATLAS/HIGG-2018-28-SMEFT/smeft-param-CPeven-linear2.txt"
...
dataload = open('validations/ATLAS/HIGG-2018-28-SMEFT/official-data/auxfig-12e-cHWB-even.csv','r')
dorix = []
doriy = []
