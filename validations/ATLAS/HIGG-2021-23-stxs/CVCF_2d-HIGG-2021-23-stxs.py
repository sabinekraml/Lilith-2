...
exp_input = "validations/ATLAS/HIGG-2021-23-stxs/HIGG-2021-23-stxs.list"
# Sm predictions     
smpred_input = "validations/ATLAS/HIGG-2021-23-stxs/SMPrediction-gammagamma.txt"
smbin_corr_input = "validations/ATLAS/HIGG-2021-23-stxs/SMbin-corr.txt" 
...
outputplot = "validations/ATLAS/HIGG-2021-23-stxs/CVCF_2d_STXS_gammagamma.pdf"
...
dataload = open('validations/ATLAS/HIGG-2021-23-stxs/ATLAS-official-gammagamma-68.csv','r')
dorix = []
doriy = []
...
plt.title("  Lilith - STXS - test - HIGG-2021-23", fontsize=15, ha="center")
...
print("results are stored in", lilith_dir + "/validations/ATLAS/HIGG-2021-23-stxs/")
print("***** done *****")
