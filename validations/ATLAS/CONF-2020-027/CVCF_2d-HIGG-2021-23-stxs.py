...
exp_input = "validations/ATLAS/HIGG-2021-23-Oct22/HIGG-2021-23-stxs.list"
# Sm predictions     
smpred_input = "validations/ATLAS/HIGG-2021-23-Oct22/SMbin-prediction.txt"
smbin_corr_input = "validations/ATLAS/HIGG-2021-23-Oct22/SMbin-corr.txt" 
...
outputplot = "validations/ATLAS/HIGG-2021-23-Oct22/CVCF_2d_STXS.pdf"
...
plt.title("  Lilith - STXS - test - HIGG-2021-23", fontsize=17, ha="center")
...
print("results are stored in", lilith_dir + "/validations/ATLAS/HIGG-2021-23-Oct22/")
print("***** done *****")
