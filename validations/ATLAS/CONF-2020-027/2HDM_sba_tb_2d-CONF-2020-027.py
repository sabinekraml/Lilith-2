...
if type == 1:
  ...
  outputplot = "validations/ATLAS/CONF-2020-027/cba_tb_I_h_2d.pdf"

if type == 2:
  output = "results/cba_tb_II_h_2d.out"
  outputplot = "validations/ATLAS/CONF-2020-027/cba_tb_II_h_2d.pdf"
...
if type == 1:
  ...
  plt.text(0.08, 0.16, r'(ATLAS-CONF-2020-027)', fontsize=12)
if type == 2:
  plt.xlim([-0.151,0.601])
  plt.text(0.21, 0.2, r'2HDM Type-II', fontsize=15)
  plt.text(0.21, 0.16, r'(ATLAS-CONF-2020-027)', fontsize=12)

fig.set_tight_layout(True)

# read data for official 68% and 95% CL contours & plot (added by TQL)
# expdata = np.genfromtxt('validations/ATLAS/CONF-2020-027/ATLAS-CONF-2020-027-fig_17a.txt')
expdata = np.genfromtxt('validations/ATLAS/CONF-2020-027/ATLAS-CONF-2020-027-fig_17b.txt')
xExp = expdata[:,0]
yExp = expdata[:,1]
...
print("results are stored in", lilith_dir + "/validations/ATLAS/CONF-2020-027/")
print("***** done *****")
