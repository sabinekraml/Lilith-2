...
outputplot = "validations/ATLAS/CONF-2020-027/CVCF_2d.pdf"
...
expdata = np.genfromtxt('validations/ATLAS/CONF-2020-027/ATLAS-CONF-2020-027-fig_11.txt')
xExp = expdata[:,0]
yExp = expdata[:,1]
...
plt.text(0.83, 0.75, r'Exp. input: ATLAS-CONF-2020-027', fontsize=12)
