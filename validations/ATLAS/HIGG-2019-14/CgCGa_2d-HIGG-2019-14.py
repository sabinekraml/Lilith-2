...
outputplot = "validations/ATLAS/HIGG-2019-14/CgluCgam_2d.pdf"
...
plt.text(0.83, 1.3, r'Exp. input: ATLAS-HIGG-2019-14.xml', fontsize=13)
...
print("results are stored in", lilith_dir + "/validations/ATLAS/HIGG-2019-14/")
print("***** done *****")
