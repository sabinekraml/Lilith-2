...
exp_input = "validations/ATLAS/HIGG-2021-23/LatestRun2-ATLAScombination-tautau.list"
...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "validations/ATLAS/HIGG-2021-23/CVCF-ATLAS-Run2-tautau-test.out"
outputplot = "validations/ATLAS/HIGG-2021-23/CVCF-ATLAS-Run2-tautau-test.pdf"
...
dataload = open('validations/ATLAS/HIGG-2021-23/ATLAS-official-tautau-68.csv','r')
dorix = []
doriy = []
...
plt.plot([0.9789883268482491],[0.9913043478260869], 'P', c='k', ms=6, label="ATLAS official best fit")
