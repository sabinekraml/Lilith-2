...
dataload = open('validations/ATLAS/HIGG-2021-23/ATLAS-official-gammagamma-68.csv','r')
dorix = []
doriy = []
...
plt.plot([1.019402985074627],[0.9571428571428571], 'P', c='k', ms=6, label='ATLAS official best fit')
...
plt.text(0.91, 1.25, r'Exp. input type = vn', fontsize=10, ha = 'left')
