...
exp_input = "validations/ATLAS/HIGG-2021-23/LatestRun2-ATLAScombination-WW.list"
...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "validations/ATLAS/HIGG-2021-23/CVCF-ATLAS-Run2-WW-test.out"
outputplot = "validations/ATLAS/HIGG-2021-23/CVCF-ATLAS-Run2-WW-test.pdf"
