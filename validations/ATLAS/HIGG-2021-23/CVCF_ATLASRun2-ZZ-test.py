...
exp_input = "validations/ATLAS/HIGG-2021-23/LatestRun2-ATLAScombination-ZZ.list"
...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "validations/ATLAS/HIGG-2021-23/CVCF-ATLAS-Run2-ZZ-test.out"
outputplot = "validations/ATLAS/HIGG-2021-23/CVCF-ATLAS-Run2-ZZ-test.pdf"
...
dataload = open('validations/ATLAS/HIGG-2021-23/ATLAS-official-ZZ-68.csv','r')
dorix = []
doriy = []
...
plt.plot([1.0393767705382437],[0.864935064935065], 'P', c='k', ms=6, label="ATLAS official best fit")
...
plt.title("  Lilith-2.1, ATLAS-2021-23 "+r' $H\to ZZ^*$' +' validation', fontsize=10, ha="center")
plt.xlabel(r'$C_V$',fontsize=15)
plt.ylabel(r'$C_F$',fontsize=15)
plt.text(0.91, 1.2, r'Exp. input type = vn', fontsize=10, ha = 'left')
