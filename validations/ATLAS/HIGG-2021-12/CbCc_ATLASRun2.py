...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "validations/ATLAS/HIGG-2021-12/cbcc-run2-HIGG-2021-12.out"
outputplot = "validations/ATLAS/HIGG-2021-12/cbcc-run2-HIGG-2021-12.pdf"
...
dataload = open('validations/ATLAS/HIGG-2021-12/HIGG-2021-12.csv','r')
dorix = []
doriy = []
