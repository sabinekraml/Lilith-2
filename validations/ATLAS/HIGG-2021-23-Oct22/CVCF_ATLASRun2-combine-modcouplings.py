...
outputplot = "validations/ATLAS/HIGG-2021-23-Oct22/CVCF-ATLAS-Run2-combine-modcoupling-gamma5.pdf"
#outputplot = "validations/ATLAS/HIGG-2021-23-Oct22/CVCF-ATLAS-Run2-combine-modcoupling-withThError.pdf"
...
plt.text(0.96, 1.1, r'include theoretical error, approx 3', fontsize=10, ha = 'left')
