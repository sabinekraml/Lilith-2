...
if (not os.path.exists("results")):
    os.mkdir("results")
output = "validations/ATLAS/HIGG-2021-23-Oct22/CVCF-ATLAS-Run2-HIGG-2021-23.out"
outputplot = "validations/ATLAS/HIGG-2021-23-Oct22/CgCga-ATLAS-Run2-HIGG-2021-23.pdf"
#outputplot = "validations/ATLAS/HIGG-2021-23-Oct22/CgCga-ATLAS-Run2-HIGG-2021-23-withThError.pdf"
...
dataload = open('validations/ATLAS/HIGG-2021-23-Oct22/ATLAS-combine-cgcgm.csv','r')
dorix = []
doriy = []
...
plt.title("  Lilith-2.1, ATLAS HIGG-2021-23 validation", fontsize=15, ha="center")
plt.xlabel(r'$C_g$',fontsize=15)
plt.ylabel(r'$C_\gamma$',fontsize=15)
plt.text(0.87, 1.17, r'Exp. input type = vn', fontsize=13)
