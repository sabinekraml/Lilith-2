...
outputplot = "validations/ATLAS/CONF-2019-004/CgluCgam_2d.pdf"
...
plt.text(0.83, 3.3, r'Exp. input: ATLAS-CONF-2019-004.xml', fontsize=13)
...
print("results are stored in", lilith_dir + "/validations/ATLAS/CONF-2019-004/")
print("***** done *****")
