...
#def Scalcalign(mh, mH, mA, mHpm, sinba):
#	cosba = np.sqrt(1-sinba**2) cos(beta-alpha)
#	cste = 1/(np.pi*mZ**2)
#	return cste*(
...
#def Tcalcalign(mh, mH, mA, mHpm, sinba):
#	cosba = np.sqrt(1-sinba**2) #cos(beta-alpha)
#	cste = 1/(16*np.pi*mW**2*sW2)
#	return cste*( 
...
#print("S with values from Fig. 2 of [2] = ", Scalc(mh = 125, mH = 1396, mA = 1024, mHpm = 1000, sinba = 1))
#print("T with values from Fig. 2 of [2] = ", Tcalc(mh = 125, mH = 1396, mA = 1024, mHpm = 1000, sinba = 1))
#print("U with values from Fig. 2 of [2] = ", Ucalc(mh = 125, mH = 1396, mA = 1024, mHpm = 1000, sinba = 1))

#print("S with values from App. A in [3] = ", Scalc(mh = 80, mH = 200, mA = 140, mHpm = 160, sinba = 0.2))
#print("T with values from App. A in [3] = ", Tcalc(mh = 80, mH = 200, mA = 140, mHpm = 160, sinba = 0.2))
#print("U with values from App. A in [3] = ", Ucalc(mh = 80, mH = 200, mA = 140, mHpm = 160, sinba = 0.2))
