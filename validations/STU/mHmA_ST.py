...
for mH in np.linspace(mH_min, mH_max, grid_subdivisions):
    ...
    for mA in np.linspace(mA_min, mA_max, grid_subdivisions):
        m2logL = func([calc.Scalc(mh = 125, mH = mH + 1000, mA = mA + 1000, mHpm = 1000, sinba = 1) , calc.Tcalc(mh = 125, mH = mH + 1000, mA = mA + 1000, mHpm = 1000, sinba = 1) ], Scen, Tcen, Ssigma, Ssigma, Tsigma, Tsigma, STcorrelation)
