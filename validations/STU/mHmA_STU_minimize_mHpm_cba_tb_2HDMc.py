...
validation_dir = lilith_dir+"validations/STU/rangeminimize2HDMc_mHpm_cba_tb/"
...
#        print("mA = ", mA, flush=True)
        funcminimized = minimize(func, [(mH+mA)/2,cba0,tb0] , args=(mH, mA), method='SLSQP', bounds=((mHpm_min,mHpm_max),(cba_min,cba_max),(tb_min,tb_max)), options={'ftol': 1e-3} )
