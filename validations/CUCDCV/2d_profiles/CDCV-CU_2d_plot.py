...
# Output files
output36 = validation_dir+"CDCV-CU_2dprofiles_36fb-1_minuit.out"
output140 = validation_dir+"CDCV-CU_2dprofiles_140fb-1_minuit.out"
outputplot = validation_dir+"CDCV-CU_2dprofiles.pdf"
...
ax.set_aspect((CD_max-CD_min)/(CV_max-CV_min))



# best Lilith fit point
plt.plot([CDmin36],[CVmin36], '*', markersize=8, color = 'black', label = 'Lilith best fit')
...
# best Lilith fit point
plt.plot([CDmin140],[CVmin140], '*', markersize=8, color = 'black', label = 'Lilith best fit')
