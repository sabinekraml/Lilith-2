...
outputplot = "plots/profilingfits_comparison.pdf"
...
ax.contourf(xi36_1,yi36_1,Z36_1,[10**(-10),2.3,5.99],colors=['#ff3300','#ffa500'])#, \
...
# Plotting the 68% and 95% CL regions
ax.contourf(xi140_1,yi140_1,Z140_1,[10**(-10),2.3,5.99],colors=['#ff3300','#ffa500'])#, \
              #vmin=0, vmax=20, origin='lower', extent=[x.min(), x.max(), y.min(), y.max()])
...
# Plotting the 68% and 95% CL regions
ax.contourf(xi36_2,yi36_2,Z36_2,[10**(-10),2.3,5.99],colors=['#ff3300','#ffa500'])#, \
              #vmin=0, vmax=20, origin='lower', extent=[x.min(), x.max(), y.min(), y.max()])
...
# Plotting the 68% and 95% CL regions
ax.contourf(xi140_2,yi140_2,Z140_2,[10**(-10),2.3,5.99],colors=['#ff3300','#ffa500'])#, \
              #vmin=0, vmax=20, origin='lower', extent=[x.min(), x.max(), y.min(), y.max()])
...
# Plotting the 68% and 95% CL regions
ax.contourf(xi36_3,yi36_3,Z36_3,[10**(-10),2.3,5.99],colors=['#ff3300','#ffa500'])#, \
              #vmin=0, vmax=20, origin='lower', extent=[x.min(), x.max(), y.min(), y.max()])
...
# Plotting the 68% and 95% CL regions
ax.contourf(xi140_3,yi140_3,Z140_3,[10**(-10),2.3,5.99],colors=['#ff3300','#ffa500'])#, \
              #vmin=0, vmax=20, origin='lower', extent=[x.min(), x.max(), y.min(), y.max()])
