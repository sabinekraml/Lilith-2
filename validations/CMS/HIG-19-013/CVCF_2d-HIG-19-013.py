...
# outputplot = "validations/CMS/HIG-19-013/CVCF_2d.pdf"
outputplot = "validations/CMS/HIG-19-013/CVCF_2d_f.pdf"
...
# expdata = np.genfromtxt('validations/CMS/HIG-19-015/CMS-PAS-HIG-19-013_CVCF-Grid.txt')
# xExp = expdata[:,0]
# yExp = expdata[:,1]
...
plt.text(0.63, 0.41, r'Exp. input: CMS-HIG-19-013', fontsize=12)
