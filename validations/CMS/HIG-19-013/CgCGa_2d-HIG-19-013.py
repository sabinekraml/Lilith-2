...
# outputplot = "validations/CMS/HIG-19-013/CgluCgam_2d.pdf"
outputplot = "validations/CMS/HIG-19-013/CgluCgam_2d_f.pdf"
...
# expdata = np.genfromtxt('validations/CMS/HIG-19-015/CMS-PAS-HIG-19-013_CgCGa-Grid.txt')
# xExp = expdata[:,0]
# yExp = expdata[:,1]
...
plt.text(0.83, 0.74, r'Exp. input: CMS-HIG-19-013', fontsize=13)
...
print("results are stored in", lilith_dir + "/validations/CMS/HIG-19-013/")
print("***** done *****")
