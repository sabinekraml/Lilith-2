...
validation_dir = lilith_dir+"validations/CMS/HIG-21-013-as/"
...
exp_input = validation_dir+"latestRun2_140fb-1.list"
...
# Output files
output = validation_dir+"HIG-21-013-CVCF_2d.out"
outputplot = validation_dir+"HIG-21-013-CVCF_2d.pdf"
...
ax.contourf(xi,yi,Z,[10**(-10),2.3,5.99],colors=['#299bcc','#6cc7e3'])#, \
...
expdata = np.genfromtxt(validation_dir+'HIG-21-013_CVCF-Grid.txt')
xExp68 = expdata[1:82,0]
yExp68 = expdata[1:82,1]
plt.plot(xExp68,yExp68,'--',markersize=3, color = '#299bcc', label="CMS official 68% CL")
#plt.plot(xExp68,yExp68,'.',markersize=5, color = 'red', label="CMS official 68% CL")
xExp95 = expdata[83:,0]
#print(xExp95)
yExp95 = expdata[83:,1]
#print(yExp95)
...
#print(xExp68)
#print(yExp68)
plt.plot(xExp95,yExp95,'--',markersize=3, color = '#6cc7e3', label="CMS official 95% CL")
#plt.plot(xExp95,yExp95,'.',markersize=3, color = 'blue', label="CMS official 95% CL")
xExpbf = expdata[0,0]
yExpbf = expdata[0,1]
plt.plot(xExpbf,yExpbf,'D',markersize=4, color = '#ff0800', label="CMS official best fit")
...
plt.title("CV-CF validation for 140 fb$^{-1}$ data", fontsize=12, ha="center")
plt.xlabel(r'$C_V$',fontsize=18)
plt.ylabel(r'$C_F$',fontsize=18)
plt.text(0.82, 0.58, r'Data from CMS-HIG-21-013 Fig. 04', fontsize=10)
