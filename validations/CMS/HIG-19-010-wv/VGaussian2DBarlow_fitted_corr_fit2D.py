...
f = open('validations/CMS/HIG-19-010-wv/HIG-19-010-Llh-2d-Grid95.txt', 'r')
...
def func(X, sig1p, sig1m, sig2p, sig2m, p):
    z1, z2 = X[:,0], X[:,1]
    z10, z20 = 0.670562293,	0.943373494
...
#expdata = np.genfromtxt('HIG-19-010-Llh-2d-GridFull.txt')
#xExp = expdata[:,0]
#yExp = expdata[:,1]
...
#fig.savefig('CMS-HIG-19-010 (VGaussian, 95% CL, fitted corr).pdf')
