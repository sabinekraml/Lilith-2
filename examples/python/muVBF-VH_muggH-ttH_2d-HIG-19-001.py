...
plt.text(0.1, 0.17, r'Data from CMS-HIG-19-001', fontsize=9)
#plt.text(0.1, 0.1, r'$\mu$ from HEP Fig. 12 + $\rho(ggH,VBF)$ = -0.1 (hyp)', fontsize=9)
#plt.text(0.1, 0.1, r'$\mu$ from HEP Fig. 11-b + $\rho(ggH,VBF)$ from Fig. 15-a', fontsize=9)
